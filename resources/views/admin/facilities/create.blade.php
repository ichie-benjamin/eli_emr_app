...
@section('content')
    ...
    <div class="pcoded-content">
            ...
            <div class="row">
                <div class="col-lg-8 col-xs-8">
                    <div class="page-header-title pull-left">
                        ...
                        <div class="d-inline">
                            <h4 class="mt-5 mb-5">Add New Facility</h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="pcoded-inner-content">
            ...
            <form method="POST" action="{{ route('facilities.facility.store') }}" accept-charset="UTF-8" id="create_facility_form" name="create_facility_form" class="form-horizontal">
                {{ csrf_field() }}
