            ...
            <div class="page-wrapper">
                <div class="page-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
        @if(count($deathCauses) == 0)
            <div class="panel-body text-center">
                <h4>No Death Causes Available!</h4>
            </div>
        @else
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{!! route('death_causes.death_cause.destroy', $deathCause->id) !!}" accept-charset="UTF-8">
                                        ...
                                        <div class="btn-group btn-group-xs pull-right" role="group">
                                            ...
                                            <button type="submit" class="btn btn-sm btn-danger" title="Delete Death Cause" onclick="return confirm(&quot;Delete Death Cause?&quot;)">
