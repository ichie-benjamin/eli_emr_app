                ...
                <div class="row">
                    <div class="col-lg-8 col-xs-8">
                        <div class="page-header-title pull-left">
                            ...
                            <div class="d-inline">
                                <h4 class="mt-5 mb-5">{{ isset($ethnicity->name) ? $ethnicity->name : 'Ethnicity' }}</h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="page-header-breadcrumb">
                            <ul class=" breadcrumb breadcrumb-title">
                                <li class="breadcrumb-item">
                                    <a href="{{ route('ethnicities.ethnicity.edit', $ethnicity->id ) }}" class="btn btn-primary" title="Edit Ethnicity">
            ...
            <dd>{{ $ethnicity->name }}</dd>
                                    ...
                                    <form method="POST" action="{!! route('ethnicities.ethnicity.destroy', $ethnicity->id) !!}" accept-charset="UTF-8">
                                        ...
                                        <div class="btn-group btn-group-sm" role="group">
                                            ...
                                            <button type="submit" class="btn btn-danger" title="Delete Ethnicity" onclick="return confirm(&quot;Delete Ethnicity??&quot;)">
