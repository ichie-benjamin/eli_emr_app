...
@section('content')
    ...
    <div class="pcoded-content">
            ...
            <div class="row">
                <div class="col-lg-8 col-xs-8">
                    <div class="page-header-title pull-left">
                        ...
                        <div class="d-inline">
                            <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Maternal Mortality' }}</h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="pcoded-inner-content">
            ...
            <form method="POST" action="{{ route('maternal_mortalities.maternal_mortality.update', $maternalMortality->id) }}" id="edit_maternal_mortality_form" name="edit_maternal_mortality_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
                <input name="_method" type="hidden" value="PUT">
                @include ('maternal_mortalities.form', [
