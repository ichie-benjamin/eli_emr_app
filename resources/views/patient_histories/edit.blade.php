...
@section('content')
    ...
    <div class="pcoded-content">
            ...
            <div class="row">
                <div class="col-lg-8 col-xs-8">
                    <div class="page-header-title pull-left">
                        ...
                        <div class="d-inline">
                            <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Patient History' }}</h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="pcoded-inner-content">
            ...
            <form method="POST" action="{{ route('patient_histories.patient_history.update', $patientHistory->id) }}" id="edit_patient_history_form" name="edit_patient_history_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
                <input name="_method" type="hidden" value="PUT">
                @include ('patient_histories.form', [
