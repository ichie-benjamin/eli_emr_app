...
@section('content')
    ...
    <div class="pcoded-content">
            ...
            <div class="row">
                <div class="col-lg-8 col-xs-8">
                    <div class="page-header-title pull-left">
                        ...
                        <div class="d-inline">
                            <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Appointments' }}</h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="pcoded-inner-content">
            ...
            <form method="POST" action="{{ route('appointments.appointments.update', $appointments->id) }}" id="edit_appointments_form" name="edit_appointments_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
