...
@section('content')
    ...
    <div class="pcoded-content">
            ...
            <div class="row">
                <div class="col-lg-8 col-xs-8">
                    <div class="page-header-title pull-left">
                        ...
                        <div class="d-inline">
                            <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Treatment Record' }}</h4>
                        </div>
                    </div>
                </div>
        ...
        <div class="pcoded-inner-content">
            ...
            <form method="POST" action="{{ route('treatment_records.treatment_record.update', $treatmentRecord->id) }}" id="edit_treatment_record_form" name="edit_treatment_record_form" accept-charset="UTF-8" class="form-horizontal">
                {{ csrf_field() }}
